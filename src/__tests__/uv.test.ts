...
describe('unocss variants (uv) - Screen Variants', () => {
  it('should work with screenVariants/initial screen', () => {
    const button = uv(
      {
  ...
  it('the screenVariants/initial should override the defaultVariants', () => {
    const button = uv(
      {
        base: 'text-xs font-bold',
        variants: {
    ...
    const expectedResult = ['text-xs', 'font-bold', 'text-purple-500', 'text-md'];
...
describe('unocss variants (uv) - Extends', () => {
  ...
  it('should include the extended classes with screenVariants single values', () => {
    const p = uv({
      base: 'text-base text-green-500',
      variants: {
        isBig: {
  ...
  it('should include the extended classes with screenVariants multiple values', () => {
    const p = uv({
      base: 'text-base text-green-500',
      variants: {
        isBig: {
  ...
  it('should work with cn', () => {
    ...
    const resultWithoutMerge = cnBase(tvResult.concat(custom));
